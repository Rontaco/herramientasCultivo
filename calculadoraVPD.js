...
//Variables VPD
let temperaturaValue, temperaturaHoja, pvsAmbiente, pvsHoja, vp, vpd, etapa, usoFarenheit, humedad, etapaIngresada
...
form.addEventListener("submit",(e)=>{
    ...
    if (humedadValue<0 || humedadValue>100) {
        ...
        output.innerText=
    `El valor del VPD es de ${vpd} y es ${evalVPD(vpd,etapasValue)}`
    }
})
